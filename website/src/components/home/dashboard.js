...
export default class dashboard extends Component {
    ...
    render() {
        return (
            <div className="text-center max-w-lg mx-auto my-auto">

                {
                    !this.props.back ? (
                        // Create or Enter room 
                        <div className="bg-gray-700 shadow rounded-lg p-16">

                            <button className="block text-gray-400 text-xl bg-gray-900 focus:outline-none rounded-full transform hover:scale-110 duration-500 px-6 py-4 mx-auto mb-8" onClick={this.handleSubmit} value="ENTER ROOM">ENTER ROOM</button>
                            <button className="block text-gray-400 text-xl bg-gray-900 focus:outline-none rounded-full transform hover:scale-110 duration-500 px-6 py-4 mx-auto" onClick={this.handleSubmit} value="CREATE ROOM">CREATE ROOM</button>
